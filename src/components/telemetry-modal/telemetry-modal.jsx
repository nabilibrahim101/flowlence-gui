...
const messages = defineMessages({
    label: {
        ...
        defaultMessage: 'Report statistics to improve Flowlence',
        description: 'Flowlence telemetry modal label - for accessibility'
    },
    bodyText1: {
        defaultMessage: 'The Flowlence Team is always looking to better understand how Flowlence is used around the ' +
            'world. To help support this effort, you can allow Flowlence to automatically send usage information to ' +
            'the Flowlence Team.',
    ...
    privacyPolicyLink: {
        ...
        description: 'Link to the Flowlence privacy policy',
        id: 'gui.telemetryOptIn.privacyPolicyLink'
    },
    optInText: {
        defaultMessage: 'Share my usage data with the Flowlence Team',
    ...
    optOutText: {
        defaultMessage: 'Do not share my usage data with the Flowlence Team',
        description: 'Text for telemetry modal opt-in button',
                    ...
                    <p><FormattedMessage
                        ...
                        values={{
                            privacyPolicyLink: (<a
                                ...
                                href="https://flowlence.com/privacy/"
