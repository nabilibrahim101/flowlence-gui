                    ...
                    <p>
                        { /* eslint-disable max-len */ }
                        {
                            props.error ? <FormattedMessage
                                defaultMessage="We are very sorry, but it looks like you are using a browser version that Flowlence Code does not support. We recommend updating to the latest version of a supported browser such as Google Chrome, Mozilla Firefox, Microsoft Edge, or Apple Safari. "
                            ...
                            /> : <FormattedMessage
                                defaultMessage="We are very sorry, but Flowlence Code does not support this browser. We recommend updating to the latest version of a supported browser such as Google Chrome, Mozilla Firefox, Microsoft Edge, or Apple Safari."
                            ...
                            values={{
                                previewFaqLink: (
                                    <a
                                        ...
                                        href="https://flowlence.com/faq"
                                    >
                                        <FormattedMessage
                                            defaultMessage="FAQ"
                                            description="link to Flowlence Code FAQ page"
