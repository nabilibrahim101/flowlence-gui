        ...
        <div dir={props.isRtl ? 'rtl' : 'ltr'}>
            ...
            <Box className={styles.body}>
                ...
                <p>
                    ...
                    <FormattedMessage
                        defaultMessage="Unfortunately it looks like your browser or computer {webGlLink}. This technology is needed for Flowlence Code to run."
                ...
                <div className={styles.faqLinkText}>
                    <FormattedMessage
                        ...
                        description="Flowlence Code FAQ description"
